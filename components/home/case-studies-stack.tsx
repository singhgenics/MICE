          ...
          {caseStudies.map((cs, i) => (
            ...
            >
              <Reveal delay={i * 40}>
                <Link
                  href="/case-studies"
                  className="group grid grid-cols-1 overflow-hidden rounded-2xl border border-line bg-paper shadow-[0_20px_50px_-25px_rgba(16,24,35,0.35)] md:grid-cols-[1fr_1.2fr]"
                >
                  ...
                  <div className="flex flex-col justify-center p-8 md:p-10">
                    ...
                    <div className="mt-6 flex flex-wrap gap-x-8 gap-y-3 border-t border-line pt-5">
                      {cs.stats.map((s) => (
                        <div key={s.label}>
                          <p className="font-mono text-lg text-text-on-paper">{s.value}</p>
